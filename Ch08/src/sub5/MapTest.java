...
public class MapTest {
	public static void main(String[] args) {
		...
		// 데이터 출력
		System.out.println("map A값 : "+ map.get('A')); //키를 입력하기
		System.out.println("map B값 : "+ map.get('B')); //키를 입력하기
		System.out.println("map C값 : "+ map.get('C')); //키를 입력하기
		
		
		//map 반복문
		for(char k : map.keySet()) {  //map.keySet() 맵의 키를 집합으로 만든 것
