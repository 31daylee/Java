...
class Customer {   //(속성의 첫 기본값은 private이지만 상속화에 따라 protected로 변경됨)
	protected int id;
...
class VipCustomer extends Customer{ //customer 를 상속받은 VipCustomer 
	
	private double saleRatio;
	
	public VipCustomer(int id, String name) {
		super(id,name); //부모의 생성자에 잇는 값을 호출 
		super.grade = "VIP";
		super.point = 1000;
	...
	@Override
	public int calcPrice(int price) {  //Customer 에 있는 calcPrice 상속받은 메서드 
		point += price * pointRatio;
